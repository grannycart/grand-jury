% grand-jury-notes.tex
% Last modified: Fri May 27, 2022  03:21PM
...
\author{Mark Torrey}
\date{February, 2016} % Later date was set to April 2, 2017, but I believe this is the original date for writing it
\maketitle
...
You can use this power to make the government work harder for its indictments, and in doing so you can inject a small amount of real justice into our system.
...
What the ADAs are doing is herding you like cattle.
...
If you decide to indict the accused on charges, that person has the \emph{right} to take the case to a trial jury. But that person is almost certainly going to plead guilty to some or all of the crimes you charged them with in exchange for less punishment. 
They ``bargain'' with the government's lawyers, who have the upper hand because the grand jury gave them a formal charge.
90-95\% of cases are settled by plea bargaining like this.\footnote{See: \url{https://www.bja.gov/Publications/PleaBargainingResearchSummary.pdf}}
...
While it is technically possible to get them to read back from the stenographer's record, they normally won't do it unless you take a vote in your deliberations and at least 12 jurors would like to hear a readback. 
...
Grand juries have \emph{unqualified} power to decline to indict.\footnote{Check out this paper in the Cornell Law Review. It had a tremendous influence over my approach to grand jury duty. I consider myself extremely lucky to have found it and read it before my jury duty began. \url{http://www.lawschool.cornell.edu/research/cornell-law-review/upload/FairfaxGrandJuryDiscretion.pdf}} 
That is why grand jury deliberations are kept entirely secret. 
